...
export const AboutUs = () => {
  ...
  return (
    <section className="about-us">
      ...
      <p>
        Guarda las ofertas que más te gusten para no perderlas de vista y visita
        directamente desde nuestra web las páginas donde se ofertan los
      ...
      <p>
        ...
        interesante en YouTube. Habitualmente practico calistenia. Soy de reírse
      ...
      <p>
        ...
        especialista en desarrollo profesional, que nos han ayudado en cada paso
        que dabamos.
      </p>
      ...
      <p>
        Para cualquier duda que puedas tener con respecto a la web, no dudes en
        contactar con nosotros a través de nuestras redes sociales que
